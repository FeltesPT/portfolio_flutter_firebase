define(['dart_sdk', 'packages/Feltes/generated_plugin_registrant', 'packages/flutter_web_plugins/flutter_web_plugins', 'packages/Feltes/main'], function(dart_sdk, packages__Feltes__generated_plugin_registrant, packages__flutter_web_plugins__flutter_web_plugins, packages__Feltes__main) {
  'use strict';
  ...
  const generated_plugin_registrant = packages__Feltes__generated_plugin_registrant.generated_plugin_registrant;
  const plugin_registry = packages__flutter_web_plugins__flutter_web_plugins.src__plugin_registry;
  const main = packages__Feltes__main.main;
  ...
  dart.trackLibraries("packages/Feltes/main_web_entrypoint", {
    "package:Feltes/main_web_entrypoint.dart": main_web_entrypoint
  }, {
